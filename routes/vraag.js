...
module.exports = express
  ...
  .get('/', async (req, res, next) => {
    try {
      res.json(await Vraag.get(req.query.page))
    } catch (err) {
  ...
  .get('/:id', async (req, res, next) => {
    try {
      res.json(await Vraag.getById(req.params.id))
    } catch (err) {
      res.json({
  ...
  .put('/', async (req, res, next) => {
    try {
      res.json(await Vraag.put(new Vraag(req.body)))
    } catch (err) {
      res.json({
  ...
  .patch('/', async (req, res, next) => {
    try {
      res.json(await Vraag.patch(req.body))
    } catch (err) {
      res.json({
  ...
  .delete(['/', '/:id'], async (req, res, next) => {
    try {
      res.json(await Vraag.delete(req.params.id || req.body.id))
    } catch (err) {
      res.json({
